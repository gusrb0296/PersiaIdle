...
public class ArmorInfo : Equipment
{
    ...
    public void SetArmorInfo(string name, int quantity, int level, bool OnEquipped, EEquipmentType type, ERarity eRarity,
        int enhancementLevel, int basicEquippedEffect, int basicOwnedEffect, int basicAwakenEffect, Color myColor, int baseEnhanceStoneRequired, int baseEnhanceStoneIncrease,bool isOwned = false, bool isAwaken = false)
    {
        this.equipName = name;
