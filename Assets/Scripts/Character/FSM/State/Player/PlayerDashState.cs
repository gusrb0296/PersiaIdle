...
{
    public PlayerDashState(StateMachine stateMachine) : base(stateMachine)
    {
    }
    ...
    public override void Enter()
    {
        ...
        StartAnimation(stateMachine.animationData.DashHash);
    }
    ...
    public override void Exit()
    {
        ...
        StopAnimation(stateMachine.animationData.DashHash);
    }
